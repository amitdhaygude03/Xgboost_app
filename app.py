...
st.markdown("<div style='text-align: right;'><h4 style='color: white;'>Developed by: Amit Dhaygude</h4>", unsafe_allow_html=True) 
st.markdown("<div style='text-align: right;'><h4 style='color: white;'>Email: amitdhaygude22@gmail.com</h4>", unsafe_allow_html=True)
